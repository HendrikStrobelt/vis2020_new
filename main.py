...
def main(site_data_path):
    ...
    for typ in ["papers", "posters", "speakers", "workshops"]:
        by_uid[typ] = {}
...
def format_paper(v):
    ...
    return {
        ...
        "content": {
            ...
            "pdf_local": v.get("pdf_local", ""),
            "ieee_link": v.get("ieee_link", ""),
        },
    }
